  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] px-4">
      <div className="bg-white/90 rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        {error && (
          <p className="py-3 bg-gradient-to-r from-[#fff5f5] to-[#ffe5e5] shadow-md text-center text-red-600 text-sm tracking-wide animate-bounce">
            {error}
          </p>
        )}
        {success && (
          <p className="py-3 bg-gradient-to-r from-[#f0fff4] to-[#dcfce7] shadow-md text-center text-green-600 text-sm tracking-wide animate-bounce">
            {success}
          </p>
        )}
